		...
		<div id="page-wrapper" style="background:url('/admin/images/litiqs.jpg') no-repeat 100% 100%;">
				...
				<tbody>
					...
					<tr>
						...
						<td style="width:236px;">
							<form action="/admin/goodsinfo/create" method="get" style="display: inline-block;" >
							{{ csrf_field() }}
			...
			<script type="text/javascript">
				...
				function del(id,obj){
					...
					$.post('/admin/goods/'+id,{'_method':'DELETE',file:file,'_token':'{{ csrf_token() }}'},function(res){
						if(res == 'ok'){
							// 删除tr节点
				...
				function kai(id,obj)
				{
					$.get('/admin/goods/status',{id:id}, function(res){
						if (res == 'ok') {
							if ($(obj).text() == '下架') {
