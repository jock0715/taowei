						...
						<div class="form-body">
						  <form action="/admin/doing" method="post" enctype="multipart/form-data">
						    ...
						    <div class="form-group">
						      ...
						      <input type="text" class="form-control" style="width:510px;" value="{{ old('price') }}" name="price" id="price" placeholder="商品原价(保留到小数点后两位)">
						  	</div>
						  	<div class="form-group">
						      <label for="money">活动价格</label>
						      <input type="text" class="form-control" style="width:510px;" value="{{ old('money') }}" name="money" id="money" placeholder="活动价格(保留到小数点后两位)">
						  	</div>
						  	<div class="form-group">
