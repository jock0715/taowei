...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper" style="background:url('/admin/images/litiqs.jpg') no-repeat 100% 100%;">
			...
			<!-- 导入 提示信息 结束 -->
			<h3 class="title1">活动商品图片管理</h3>
				<!-- 搜索 开始 -->
				<div class="form-body" data-example-id="simple-form-inline">
				  <form class="form-inline" action="/admin/doinginfo">
			...
			<div>
				<!-- 显示页码 -->
				{{ $doings_info->appends(['search'=>$search])->links() }}
			</div>
			<script type="text/javascript">
				...
				function del(id,obj){
					...
					$.post('/admin/doinginfo/'+id,{'_method':'DELETE',file:file,'_token':'{{ csrf_token() }}'},function(res){
						if(res == 'ok'){
							// 删除tr节点
