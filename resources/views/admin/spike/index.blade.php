		...
		<div id="page-wrapper" style="background:url('/admin/images/litiqs.jpg') no-repeat 100% 100%;">
			...
			<h3 class="title1">秒杀商品管理</h3>
				...
				<div class="form-body" data-example-id="simple-form-inline">
				  <form class="form-inline" action="/admin/spike">
			...
			<script type="text/javascript">
				...
				function del(id,obj){
					...
					$.post('/admin/spike/'+id,{'_method':'DELETE',file:file,'_token':'{{ csrf_token() }}'},function(res){
						if(res == 'ok'){
							// 删除tr节点
				...
				function kai(id,obj)
				{
					$.get('/admin/spike/status',{id:id}, function(res){
						if (res == 'ok') {
							if ($(obj).text() == '下架') {
