					...
					<div class="am-g am-g-fixed">
						<div class="am-u-sm-12 am-u-md-12">
							<div class="search-content">
								<div class="sort">
									<li class="first"><a href="javascript:;" title="综合">综合排序</a></li>
									<li><a href="/home/doinglist/saleindex?search={{ $search }}" title="销量">销量排序</a></li>
									<li><a href="/home/doinglist/priceindex?search={{ $search }}" title="价格">价格优先</a></li>
									<!-- <li class="big"><a title="评价" href="#">评价为主</a></li> -->
								</div>
								<div class="clear"></div>

								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
									@foreach($doings_data as $k=>$v)
									<li>
							...
							<!--分页 -->
							<div class="page_page">
								{{ $doings_data->appends(['search'=>$search])->links() }}
							</div>
