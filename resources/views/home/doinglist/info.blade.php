        ...
        @include('home/public/message')
			...
			<div class="listMain">
				...
				<ol class="am-breadcrumb am-breadcrumb-slash">
					<li><a href="/">首页</a></li>
					<li><a href="/home/doinglist">活动商品</a></li>
					<li class="am-active">活动商品详情</li>
				</ol>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/uploads/{{ $doing->file }}"><img src="/uploads/{{ $doing->file }}" alt="细节展示放大镜特效" rel="/uploads/{{ $doing->file }}" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="/uploads/{{ $doing->file }}" mid="/uploads/{{ $doing->file }}" big="/uploads/{{ $doing->file }}"></a>
									</div>
								</li>
								@foreach($doinginfo as $k=>$v)
								<li>
									<div class="tb-pic tb-s40">
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-hd">
							<h1>	
				 				【{{ $doing->name }}】{{ $doing->desc }}
				 				
									<a id="a1" href="javascript:;" onclick="del({{ $doing->id }})" style="float: right; display: {{ $collection == 1 ? 'block' : 'none' }};"><span class="am-icon-heart am-icon-fw" ></span> 取消收藏</a>
									
					 				<a id="a2" href="javascript:;" onclick="collection({{ $doing->id }})" style="float: right; display: {{ $collection == 1 ? 'none' : 'block' }};"><span class="am-icon-heart am-icon-fw" style="color: red;"></span> 加入收藏</a>
						...
						<script type="text/javascript">
							...
							function collection(id) {
								$.post('/home/doingcollection', {id:id,'_token':'{{ csrf_token() }}'}, function(res){
									if(res.msg == 'ok'){
										layer.msg(res.info);
										$('#a2').css('display','none');
						...
						<div class="tb-detail-list">
							...
							<ul class="tm-ind-panel">
								<li class="tm-ind-item tm-ind-sellCount canClick">
									<div class="tm-indcon"><span class="tm-label">销售量</span><span class="tm-count">{{ $doing->sale }}</span></div>
								</li>
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">库存</span><span class="tm-count">{{ $doing->over }}</span></div>
								</li>
						...
						<div class="pay">
                            ...
                            <li>
                                <div class="clearfix tb-btn tb-btn-buy theme-login">
                                    ...
                                    <a href="javascript:;" onclick="abc({{ $doing->id }})">
                                    立即购买</a>
					...
					<div class="browse">
					    <div class="mc"> 
						     <ul>					    
						     	...
						     	@foreach($cate_doings3 as $k=>$v)
							      <li>
							      	<div class="p-img">                    
							      		<a  href="/home/doinglist/info/{{ $v->id }}"> <img class="" src="/uploads/{{ $v->file }}"> </a>               
							      	</div>
							      	<div class="p-name"><a href="/home/doinglist/info/{{ $v->id }}">
							      		【{{ $v->name }}】{{ $v->desc }}
							      	</a>
							      	</div>
											...
											<div class="am-comment-main">
												...
												<header class="am-comment-hd">
													...
													<div class="am-comment-meta">
														<!-- 评论元数据 -->
														<a href="#link-to-user" class="am-comment-author">{{ $v->commentdusers->uname }}</a>
														<!-- 评论者 -->
														评论于：
												...
												<div class="am-comment-bd">
													<div class="tb-rev-item " data-id="255776406962">
														...
														<div class="tb-r-act-bar">
															服装规格：<span style="color: red">{{ $v->commentdorders->desc }}</span>
														</div>
													</div>
