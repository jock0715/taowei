...
class Spike_listController extends Controller
{
    ...
    {   
        ...
        if(session('home_login')){
            ...
            // 查找出该用户所有收藏的秒杀商品
            $spike_collection = User::find($uid)->userspikecollection;
        ...
        // dd($gid);
        // 加载页面
        return view('home/spikelist/info',['spike'=>$spike,'spikeinfo'=>$spikeinfo,'cate_spikes'=>$cate_spikes,'spike_collection'=>$spike_collection]);
